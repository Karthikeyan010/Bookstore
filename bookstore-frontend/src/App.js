...
const CATALOG_API_URL = 'http://34.89.23.221:8080/api/catalog';
const CART_API_URL = 'http://34.89.118.25:8081/api/cart';
        ...
        <Router>
            <div className="app-container">
                <header className="app-header">
                    <h1 className="header-title">Newcastle University Book Store--- new test for pipeline1234</h1>
